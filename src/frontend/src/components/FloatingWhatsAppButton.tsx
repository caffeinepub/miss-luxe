...
export default function FloatingWhatsAppButton() {
  return (
    <a
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 6px 28px oklch(0.52 0.17 145 / 0.7)';
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 20px oklch(0.52 0.17 145 / 0.5)';
      }}
    >
