...
export default function Footer() {
  ...
  const waUrl = `https://wa.me/917045899262?text=${encodeURIComponent("Hello Miss Luxe! 🌹\n\nI'd like to get in touch. Could you please help me?")}`;
              ...
              {[
                ...
                <li key={link.href}>
                  <a
                    ...
                    className="font-sans text-luxury-beige/50 text-sm hover:text-luxury-gold transition-colors cursor-pointer"
                  >
                    {link.label}
                  </a>
                </li>
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    window.location.href =
                      "https://www.instagram.com/miss.luxeco";
                  }}
                  className="flex items-center gap-3 font-sans text-luxury-beige/50 text-sm hover:text-luxury-gold transition-colors"
