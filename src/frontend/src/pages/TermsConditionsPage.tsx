    ...
    <div className="min-h-screen bg-luxury-black font-sans">
      ...
      <main className="pt-20">
        <PolicyHero
          ...
          subtitle="Governing Your Experience with Miss Luxe"
        />
        ...
        >
          <div className="max-w-3xl mx-auto px-6 lg:px-12">
            <PolicySection title="1. Acceptance of Terms">
              <p>
                By accessing or using the Miss Luxe website and placing an
                order, you agree to be bound by these Terms and Conditions. If
                you do not agree to these terms, please refrain from using our
                services.
              </p>
              <p>
                Miss Luxe reserves the right to modify these terms at any time.
            ...
            <PolicySection title="2. Use of Website">
              <p>
                ...
                may not reproduce, distribute, or exploit any content from this
                website without prior written consent from Miss Luxe.
              </p>
              <p>
                You agree not to use this website for any unlawful purpose or in
                any manner that could damage, disable, or impair the website's
                functionality.
              </p>
            </PolicySection>
            ...
            <PolicySection title="3. Product Information">
              <p>
                We endeavour to ensure that all product descriptions, images,
                and pricing on this website are accurate. However, Miss Luxe
                reserves the right to correct any errors or inaccuracies and to
                change or update information at any time without prior notice.
              </p>
              <p>
                Product images are for illustrative purposes only. Actual
                products may vary slightly in appearance due to the handcrafted
                nature of our creations.
              </p>
            </PolicySection>

            <PolicySection title="4. Order Acceptance">
              <p>
                The placement of an order does not constitute a binding contract
                until payment has been confirmed and an order confirmation has
                been issued by Miss Luxe. We reserve the right to refuse or
                cancel any order at our discretion.
              </p>
              <p>
                In the event of a pricing error, we will notify you and offer
            ...
            <PolicySection title="5. Payment Terms">
              <p>
                All orders are processed on a{" "}
                <strong>prepaid basis only</strong>. Payment must be completed
                in full before an order is dispatched. We accept payments via
                the methods communicated through our WhatsApp ordering process.
              </p>
              <p>
                All prices are listed in Indian Rupees (₹) and are inclusive of
                premium packaging. Applicable taxes are included in the
                displayed price.
              </p>
            </PolicySection>
            ...
            <PolicySection title="6. Intellectual Property">
              <p>
                ...
                images, logos, and design elements, is the exclusive
                intellectual property of Miss Luxe and is protected by
            ...
            <PolicySection title="7. Limitation of Liability">
              <p>
                Miss Luxe shall not be liable for any indirect, incidental, or
                consequential damages arising from the use of our products or
                services. Our liability is limited to the value of the order
                placed.
              </p>
              <p>
                We are not responsible for delays or failures in delivery caused
                by circumstances beyond our reasonable control, including but
                not limited to natural disasters, strikes, or courier
                disruptions.
              </p>
            </PolicySection>
            ...
            <PolicySection title="9. Contact">
              <p>
                ...
                contact us via WhatsApp at <strong>+91 70458 99262</strong> or
                email us at hello@missluxe.com.
              </p>
            </PolicySection>
