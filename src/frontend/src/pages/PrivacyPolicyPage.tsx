    ...
    <div className="min-h-screen bg-luxury-black font-sans">
      ...
      <main className="pt-20">
        <PolicyHero
          ...
          subtitle="Your Trust is Our Highest Commitment"
        />
        ...
        >
          <div className="max-w-3xl mx-auto px-6 lg:px-12">
            <PolicySection title="Information We Collect">
              <p>
                When you place an order or make an enquiry with Miss Luxe, we
                collect certain personal information necessary to fulfil your
                order. This may include your name, delivery address, phone
                number, and email address.
              </p>
              <p>
                We collect only the information that is strictly necessary for
                the purpose of processing your order and providing you with the
            ...
            <PolicySection title="How We Use Your Information">
              <p>
                The personal information you provide is used exclusively for the
                following purposes:
              </p>
            ...
            <PolicySection title="Data Protection & Security">
              <p>
                Miss Luxe is committed to protecting your personal information.
                We implement appropriate technical and organisational measures
                to safeguard your data against unauthorised access, disclosure,
                alteration, or destruction.
              </p>
              <p>
                Your information is stored securely and is accessible only to
                authorised personnel who require it to fulfil your order or
            ...
            <PolicySection title="Third-Party Disclosure">
              <p>
                Miss Luxe does not sell, trade, or otherwise transfer your
                personal information to third parties, except as necessary to
                fulfil your order. This includes sharing your delivery address
                with our courier partners solely for the purpose of delivering
                your order.
              </p>
              <p>
                We do not share your information with marketing companies, data
                brokers, or any other third parties for commercial purposes.
              </p>
            </PolicySection>

            <PolicySection title="WhatsApp Communication">
              <p>
                When you contact us via WhatsApp, your messages and contact
                information are processed through WhatsApp's platform, which is
                subject to WhatsApp's own privacy policy. We use WhatsApp solely
                for order communication and customer support purposes.
              </p>
              <p>
                We will not add you to any broadcast lists or marketing groups
            ...
            <PolicySection title="Your Rights">
              <p>
                ...
                of your personal information held by Miss Luxe. To exercise any
                of these rights, please contact us via WhatsApp at{" "}
                <strong>+91 70458 99262</strong> or email us at
                hello@missluxe.com.
              </p>
              <p>
                We will respond to all data-related requests within 7 business
                days.
              </p>
            </PolicySection>
            ...
            <PolicySection title="Cookies">
              <p>
                ...
                understand how you interact with our website. You may disable
            ...
            <PolicySection title="Updates to This Policy">
              <p>
                Miss Luxe reserves the right to update this Privacy Policy at
