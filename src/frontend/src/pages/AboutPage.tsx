      ...
      <main>
        ...
        <section className="py-20 md:py-28 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              "Miss Luxe was born not from commerce, but from conviction — a
              belief that luxury is not merely about price, but about the love,
              discipline, and artistry woven into every creation."
            </blockquote>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {pillars.map((pillar, i) => (
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, oklch(0.10 0.003 60) 0%, oklch(0.08 0.005 60) 100%)",
                ...
                >
                  ...
                  <span className="text-luxury-gold text-2xl mb-6 block">
                    {pillar.icon}
                  </span>
